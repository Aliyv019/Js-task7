//task 1 duzbucaqlinin perimetri ve sahesini hesabla
// for(var i=true;i==true;){
//     var width=prompt("enter the width of rectangle")
//     var height=prompt("enter the height of rectangle")
//     alert(`perimeter of rectangle:${width*2+height*2}, area of rectangle:${width*height}`);
// }

//task 1.1? ucbucagin movcud olub olmamasi ve movcuddusa ucuncu bucagin tapilmasi
// for(var i=true;i==true;){
